	...
	public KnownItemsDictionary() {
		super(ChainDictionary.<String, KnownActor>builder()
			.addDictionary(PartialKeyMapDictionary.<KnownActor>builder()
				...
				.put("Armor_Head_Cultist_PreOrder", DOOMSAYER_HAT_SKIN)
				.put("Armor_Body_Cultist_PreOrder", DOOMSAYER_DUSTER_SKIN)
				.put("Armor_Legs_Cultist_PreOrder", DOOMSAYER_BRITCHES_SKIN)
				...
				.put("Armor_Head_Hunter_PreOrder", NIGHTSTALKER_SHROUD_SKIN)
				.put("Armor_Body_Hunter_PreOrder", NIGHTSTALKER_TRENCHCOAT_SKIN)
				.put("Armor_Legs_Hunter_PreOrder", NIGHTSTALKER_PANTS_SKIN)
				...
				.put("Armor_Head_Scrapper_PreOrder", GLADIATOR_HELMET_SKIN)
				.put("Armor_Body_Scrapper_PreOrder", GLADIATOR_BODYPLATE_SKIN)
				.put("Armor_Legs_Scrapper_PreOrder", GLADIATOR_WORKBOOTS_SKIN)
